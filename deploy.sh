...
echo "=== Пишем .env ==="
cat > .env << ENVEOF
STALCRAFT_CLIENT_ID=3042
STALCRAFT_CLIENT_SECRET=NyCgsdKSynFHtPkAkOhZslIgTnoRNDvwKbZQvQYX
...
TELEGRAM_BOT_TOKEN=8629266810:AAFDqqikTztUHAjhESMue-jwjgtQuV56ybE
