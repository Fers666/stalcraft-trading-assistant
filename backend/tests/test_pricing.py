...
def test_yula_falling_market():
    ...
    # 0.97 — исторический тир «Быстро» ДО калибровки (P0-1): здесь он часть
    # воспроизводимого бага, а не текущая константа, поэтому литерал, а не
    # FAST_RATIO. С нынешним 0.94 обещание было бы скромнее, но всё равно ложным.
