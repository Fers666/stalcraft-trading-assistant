...
`P(продан ≤ 6 ч)` — **84.4 / 84.9 / 79.2 %** (`docs/tasks/sale-survival-curve.md` §2.4).
Важнее самих чисел то, что **все три тира лежат на плоском участке кривой**: разница между
«Быстро» и «Выгодно» — 5.2 п.п. вероятности при разнице цены 12.8 %. Настоящая крутизна
начинается за пределами тировой лестницы: на `ref × 1.10` вероятность падает на 11 п.п.,
на `ref × 1.30` — на 30 п.п. Множители при этом верны и не меняются: они откалиброваны по
ценам состоявшихся сделок и в этом качестве корректны.

**В ленте берётся другая стратификация** — по нормированной позиции плановой цены продажи
в стакане варианта. Она измеримо сильнее (корреляция с «продан ≤ 6 ч» **−0.330** против
**−0.138** у цены к опоре) и почти независима от неё (взаимная корреляция 0.299), а стакан
у сборщика уже в руках. Сырая глубина стакана (`cheaper_units`) непригодна: она немонотонна,
потому что смешана с ликвидностью варианта — «100+ единиц дешевле» даёт лучшую долю продаж
(81.3 %) просто потому, что такие книги бывают только у оборотистых вариантов.
