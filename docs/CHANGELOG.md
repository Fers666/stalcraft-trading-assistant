...
- [x] **Design v5 «Терминал»: внедрение в приложение, Фазы 1–5 из 7 ← 2026-07-18** — реализация по спеке `docs/tasks/design-v5-implementation.md` (conformance-доработка Избранного — `docs/tasks/design-v5-favorites-conformance.md`). Прототип-эталон — `design/v5/`. Фазы 6–7 остаются (см. `docs/NOTES.md`).
