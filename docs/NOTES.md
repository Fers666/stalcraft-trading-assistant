...
### Backend
- [ ] надо разобраться с истрорией продаж, она должна собираться раз в 5 минут если товар добавлен в watchlist   
...
- [x] **Карточка Избранного: фиксированный размер** — 440×900px, flex-wrap layout вместо Grid2; overflow: hidden + тонкий scrollbar внутри CardContent.
