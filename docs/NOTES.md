...
- [x] **Rate limit Stalcraft API: поиск и проверка ← 2026-06-07** — Документированы официальные лимиты (100 токенов/минута) из ТЗ API. Текущее использование: 54-55 токенов/мин (54-55% от лимита) — безопасно. Резерв 45-46 токенов/мин (45-46%). Детальный анализ в `RATE_LIMIT_REPORT.md` с рекомендациями по оптимизации. Сценарии: консервативный (текущий), сбалансированный (68% использования), агрессивный (> лимит, не рекомендуется).
