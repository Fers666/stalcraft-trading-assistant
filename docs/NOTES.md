...
- [ ] **Ревизия алгоритмов выгодности ← 2026-08-14** — разбор на прод-данных:
  ...
  Ключевые находки: тир «Быстро» (`ref × 0.97`) исполняется в **53.3 %** случаев — это P48
  распределения, а не быстрая цена (настоящий быстрый уровень `ref × 0.889`, разрыв 8.3 п.п.);
  **65 %** обещанной прибыли ленты стоит на 30 лотах с выборкой < 5 сделок; топ-10 ленты висит
  ...
  - [ ] Шаг 2 — P0-1: квантильные тиры вместо `0.97 / 1.00 / 1.05`;
