...
const features = [
  ...
  },
  {
    ...
    desc: 'Предметы вне твоего Избранного, которые сейчас выгодно купить и перепродать с прибылью — с учётом комиссии аукциона. Каждая заточка и качество считаются отдельным товаром.',
    accent: '#53B7FF',
  },
]
