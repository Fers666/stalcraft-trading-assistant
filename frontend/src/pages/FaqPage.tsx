...
const tierRows = [
  { tier: 'Базовая',      fav: '6',  notif: 'нет', history: '24 часа',             lots: 'нет', buy: 'нет', buyNotif: 'нет' },
  { tier: 'Продвинутая',  fav: '10', notif: 'да',  history: '24ч + 48ч',           lots: 'нет', buy: 'да',  buyNotif: 'нет' },
  { tier: 'Продвинутая+', fav: '20', notif: 'да',  history: '24ч + 48ч + 7д',      lots: 'да',  buy: 'да',  buyNotif: 'да'  },
  { tier: 'Макс',         fav: '25', notif: 'да',  history: '24ч + 48ч + 7д + 30д', lots: 'да',  buy: 'да',  buyNotif: 'да'  },
]
  ...
  return (
    <Box sx={{
      ...
      <Box component="table" sx={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.82rem' }}>
        <Box component="thead">
          <Box component="tr">
            {['Тариф', 'Предметов в Избранном', 'Уведомления в Telegram', 'История продаж', 'Раздел «Лоты»', 'Раздел «Закупки»', 'Уведомления Закупок'].map((h) => (
